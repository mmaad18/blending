        ...
        for i in range(kernel_size):
            for j in range(kernel_size):
                ...
                if idx < len(start_array):
                    ...
                    #start_location = (start_box.location[0], start_box.location[1], start_box.location[2])
                    #end_location = (end_box.location[0], end_box.location[1], end_box.location[2])
...
first_array = create_array_of_boxes(4, 0.05) # 5x5 array
second_array = create_array_of_boxes(2, 0.05, pos_0=(1.05, 4, 1.05)) # 3x3 array
...
create_set_of_pipes(first_array, second_array, 4, 4, 2, pipe_radius)
